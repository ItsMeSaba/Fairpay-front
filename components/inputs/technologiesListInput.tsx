...
export default function TechnologiesListInput(args: Args) {
        ...
        <div className={style.technologyInputContainer}>
            ...
            <div id="companyInput" className={style.technologyList} onClick={() => inputRef.current?.focus()}>
                ...
                <div className={style.inputBlock}>
                    <input placeholder="input" ref={inputRef} autoComplete="off" value={inputValue} id="companyInput" list="companyInput" onChange={handleInput} onFocus={() => setFocused(true)} onBlur={() => setFocused(false)} />
